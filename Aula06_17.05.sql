...
SELECT [NOME DO PRODUTO] AS 'DESCRICAO', [CODIGO DO PRODUTO] AS 'IDENTIFICADOR', [PRECO DE LISTA] AS 'PREÇO A PAGAR' FROM [TABELA DE PRODUTOS]

SELECT TOP(7) [NOME], [CPF], [CIDADE] FROM [dbo].[TABELA DE CLIENTES]
...
WHERE [PERCENTUAL COMISSAO] > 0.1

SELECT * FROM [TABELA DE VENDEDORES]
WHERE [DATA DE ADMISSAO] > '31-12-2016'
