...
Imagine que, pela legislação, o imposto pago depende do tipo de embalagem do produto e, a cada momento, ele muda. 
...
Ela irá modificar a alíquota para a alíquota informada na entrada da stored procedure, para as vendas de todas as notas fiscais no mês/ano informados,
para todos os produtos do tipo informado. Nome da stored procedure: AtualizaImposto. */
-- 4 parametros:
-- mes
-- ano
--aliquota
...
--PROCEDURE--- EXECUTAR APENAS UMA VEZ
